...
estimates_survival<- function(nsim,nA,nB,C,p,beta,sigma,alpha){
  ...
  return(list( coef_true_s1 = coef_true_s[,1], coef_true_s2 = coef_true_s[,2],coef_true_s3 = coef_true_s[,3],coef_true_s4 = coef_true_s[,4],
          ...
          coef_estimate_s1 = coef_estimate_s[,1], coef_estimate_s2 = coef_estimate_s[,2],coef_estimate_s3 = coef_estimate_s[,3], coef_estimate_s4= coef_estimate_s[,4], 
          coef_estimate_s_Nd1 = coef_estimate_s_Nd[,1], coef_estimate_s_Nd2 = coef_estimate_s_Nd[,2],coef_estimate_s_Nd3 = coef_estimate_s_Nd[,3], coef_estimate_s_Nd4 = coef_estimate_s_Nd[,4],
