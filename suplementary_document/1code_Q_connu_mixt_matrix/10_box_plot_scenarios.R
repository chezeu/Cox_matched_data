...
scenarios_boxplot=scenarios[(scenarios$nA==1000 & scenarios$nB!=4000)&
                              (scenarios$censor==0.4020902& scenarios$nB!=6000),] 
...
for (i in (1:nrow(scenarios_boxplot))){
  ...
  load(paste0("C:/Users/fchezeut/Documents/GitHub/Cox-matched-data/suplementary_document/1code_Q_connu_mixt_matrix/Results/","nsim=",nsim,
...
scenarios_boxplot=scenarios[(scenarios$alpha==0.9& scenarios$nB!=4000)&
                              (scenarios$censor==0.4020902& scenarios$nB!=6000),] 
...
source("7_scenarios.R")
#scenarios_boxplot=scenarios[scenarios$alpha==0.8,] 
scenarios_boxplot = scenarios[(scenarios$alpha==0.9& scenarios$nB!=6000) &
                                (scenarios$nA==1000 & scenarios$nB!=4000),] 
...
##############    nA fixed and R varies ######

setwd("C:/Users/fchezeut/Documents/GitHub/Cox-matched-data/suplementary_document/1code_Q_connu_mixt_matrix")

source("7_scenarios.R")
#scenarios_boxplot=scenarios[scenarios$alpha==0.8,] 
scenarios_boxplot =  scenarios[(scenarios$alpha==0.9 & scenarios$censor!=1.553309)&
