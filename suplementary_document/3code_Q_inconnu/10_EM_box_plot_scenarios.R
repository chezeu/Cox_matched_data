...
setwd("C:/Users/fchezeut/Documents/GitHub/Cox-matched-data/suplementary_document/3code_Q_inconnu")
...
for (i in (1:nrow(scenarios_boxplot))){
  ...
  load(paste0("C:/Users/fchezeut/Documents/GitHub/Cox-matched-data/suplementary_document/3code_Q_inconnu/Results/",
...
source("7_EM_scenarios.R")
#scenarios_boxplot=scenarios[scenarios$K==9,] 
scenarios_boxplot=scenarios[(scenarios$censor==0.4020902 & scenarios$K==16)&
...
source("7_EM_scenarios.R")
#scenarios_boxplot=scenarios[scenarios$K==9,] 
scenarios_boxplot=scenarios[(scenarios$K==16 & scenarios$censor!=0.5739009)&
                              (scenarios$nA==1000& scenarios$censor!=0.2924500), ] 
#scenarios_boxplot=scenarios[scenarios$K==27,] 
